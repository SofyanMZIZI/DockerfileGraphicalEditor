...
/**
 * This is the item provider adapter for a {@link com.s5.mde.dockerfiledsl.Interval} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntervalItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addStrPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Interval_str_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Interval_str_feature",
								"_UI_Interval_type"),
						DockerfiledslPackage.Literals.INTERVAL__STR, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Interval) object).getStr();
		return label == null || label.length() == 0 ? getString("_UI_Interval_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case DockerfiledslPackage.INTERVAL__STR:
