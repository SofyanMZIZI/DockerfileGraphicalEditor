 ...
 * </p>
 * <ul>
 *   <li>{@link com.s5.mde.dockerfiledsl.impl.DockerfileImpl#getPath <em>Path</em>}</li>
 *   <li>{@link com.s5.mde.dockerfiledsl.impl.DockerfileImpl#getInstructions <em>Instructions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DockerfileImpl extends MinimalEObjectImpl.Container implements Dockerfile {
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DockerfiledslPackage.DOCKERFILE__PATH, oldPath,
					path));
	}
	...
	public EList<Instruction> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentEList<Instruction>(Instruction.class, this,
					DockerfiledslPackage.DOCKERFILE__INSTRUCTIONS);
		}
		return instructions;
	}
