 ...
 * </p>
 * <ul>
 *   <li>{@link com.s5.mde.dockerfiledsl.impl.ENTRYPOINTImpl#getCommand <em>Command</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ENTRYPOINTImpl extends InstructionImpl implements ENTRYPOINT {
	...
	protected EClass eStaticClass() {
		return DockerfiledslPackage.Literals.ENTRYPOINT;
	}
	...
	public NotificationChain basicSetCommand(Command newCommand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DockerfiledslPackage.ENTRYPOINT__COMMAND, oldCommand, newCommand);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCommand != command) {
			...
			if (command != null)
				msgs = ((InternalEObject) command).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - DockerfiledslPackage.ENTRYPOINT__COMMAND, null, msgs);
			if (newCommand != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DockerfiledslPackage.ENTRYPOINT__COMMAND, newCommand,
					newCommand));
	}
